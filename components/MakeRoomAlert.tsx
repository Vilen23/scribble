...
import { MakeRoom } from '@/lib/actions/makeroom';
...
export default function MakeRoomAlert() {
  ...
  return (
    <Dialog>
      <DialogTrigger>
        <button className={`${work.className} px-3 py-2 rounded-3xl bg-black text-white hover:bg-black/80`}>Make Room</button>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
          <DialogTitle className={`${serif.className} text-center text-2xl`}>Set Credentials for your room</DialogTitle>
        ...
        <div className="flex flex-col items-center justify-center gap-5">
          ...
          <div>
            <button onClick={handleCreateRoom} className={`${work.className} px-3 py-2 rounded-3xl bg-black text-white hover:bg-black/80`}>Create Room</button>
          </div>
        </div>
      </DialogContent>
    </Dialog>
